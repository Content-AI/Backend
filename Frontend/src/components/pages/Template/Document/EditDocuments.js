...
import ClosetButtonIcon from "../../../Icons/ClosetButtonIcon";
...
function EditDocuments() {
  ...
  const [hide_editor_while_sharing, set_hide_editor_while_sharing] = useState(false)
                ...
                <div className="flex items-center justify-end px-3 py-0.5 space-x-2 flex-1">
                  ...
                  <button
                    ...
                    onClick={() => {
                      ...
                      set_hide_editor_while_sharing(true)
                    }}
                  >
                    share
                  </button>
                  ...
                  <>
                    <div className="justify-center items-center flex overflow-x-hidden overflow-y-auto fixed inset-0 z-50 outline-none focus:outline-none">
                      <div className="relative my-6">
                        <div className="justify-center items-center flex overflow-x-hidden overflow-y-auto fixed inset-0 z-50 outline-none focus:outline-none">
                          <div className="relative w-full sm:w-auto md:w-auto lg:w-auto xl:w-auto my-6 mx-auto max-w-3xl">
                            {/*content*/}
                            <div className="border-0 rounded-lg shadow-lg relative flex flex-col w-full bg-white outline-none focus:outline-none">
                              {/*header*/}
                              <div className="dark:bg-gray-700 dark:border-slate-500 w-full text-left flex justify-between items-center p-6 text-gray-900 border-b border-gray-200">
                                <h3 className="text-lg font-semibold dark:text-white">Share a Document</h3>
                                <button
                                  className="p-2 hover:bg-gray-100 rounded-full hover:cursor-pointer"
                                  onClick={() => {
                                    setSharePopUpModal(false);
                                    set_hide_editor_while_sharing(false);
                                  }}
                                >
                                  <ClosetButtonIcon />
                                </button>
                              ...
                              <div>
                                ...
                                <div className="dark:bg-gray-700 dark:border-gray-700 m-auto p-8">
                                    ...
                                    <div className="flex flex-col">
                                      <div>
                                        {emails.map((enteredEmail, index) => (
                                          <span key={index} className="dark:text-black bg-gray-300 p-1 m-1 rounded w-full sm:w-[700px]">
                                            {enteredEmail}
                                            <button
                                        ...
                                        <input
                                          ...
                                          className="dark:text-black border border-gray-300 p-2 rounded mt-2 w-full sm:w-[600px]"
                                        />
                                      </div>
                                      <div className="mt-2">
                                        {emails &&
                                          <>
                                            {emails.length > 0
                                              ...
                                              <>
                                                {send_loading
                                                  ?
                                                  <button className="bg-[#334977] text-white font-bold py-2 px-4 rounded-md w-full sm:w-[200px]"
                                                    onClick={() => { }}>
                                                    Sending ...
                                                  </button>
                                                  :
                                              ...
                                              :
                                              <button className="bg-gray-400 text-white font-bold py-2 px-4 rounded-md w-full sm:w-[200px]"
                                                disabled>
                                                Send invite
                                              </button>
                                            }
                                  ...
                                  <div className="flex flex-col p-[30px] mt-5 w-full space-y-1">
                                    {/* ======================the list of users===================== */}
                                    <div className="flex flex-col w-full">
                                      <div className="w-full max-h-72 overflow-auto scrollbar-hide">
                                        {listOfUser &&
                                          <div className="flex items-center pb-4 relative">
                                            <div className="flex-shrink-0 w-10 h-10">
                                              <div className="text-base w-10 h-10 rounded-full font-bold text-white flex items-center justify-center">
                                                <img
                                            ...
                                            <div className="ml-4 truncate">
                                              <div className="dark:text-white font-medium leading-5 text-sm text-gray-900 truncate" title="copy ai">
                                                {listOfUser[0]["first_name"] ? listOfUser[0]["first_name"] : "" + " " + listOfUser[0]["last_name"] ? listOfUser[0]["last_name"] : ""}
                                              </div>
                                              <div className="leading-5 text-xs text-gray-500 truncate">{listOfUser[0]["email"]}</div>
                                            </div>
                                            <div className="ml-auto text-gray-400 text-sm font-medium px-2 w-24">Creator</div>
                                          </div>
                                        }
                                                      ...
                                                      {listOfUser[0]["editable_by_workspace_member"].map((data, index) => {
                                                        return (
                                                          <div className="flex items-center pb-4">
                                                            ...
                                                            <div className="ml-4 truncate">
                                                              <div className="dark:text-white font-medium leading-5 text-sm text-gray-900 truncate">
                                                                {data.first_name ? data.first_name : "" + " " + data.last_name ? data.last_name : ""}
                                                              </div>
                                                              <div className="leading-5 text-xs text-gray-500 truncate">{data.email}</div>
                                                            </div>
                                                        ...
                                                        return (
                                                          <div className="flex items-center pb-4 relative">
                                                            ...
                                                            <div className="ml-4 truncate">
                                                              ...
                                                              <div className="leading-5 text-xs text-gray-500 truncate" title="test@gmail.com">{data.email}</div>
                                                            </div>
                                                          </div>
                                                        )
                                                      })}
                                  ...
                                  <div class="pt-6 flex">
                                    ...
                                    <div class="ml-auto flex items-center text-gray-700">
                                      ...
                                      <button
                                        type="button"
                                        className={`relative inline-flex items-center flex-shrink-0 border-2 rounded-full cursor-pointer transition-colors ease-in-out duration-150 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500 ${isOn ? 'bg-indigo-500' : 'bg-gray-200'
                                          } h-6 w-11`}
                                        onClick={handleToggle}
                                      >
                                        <span
                                          aria-hidden="true"
                                          className={`pointer-events-none inline-block rounded-full bg-white shadow transform ring-0 transition ease-in-out duration-150 ${isOn ? 'translate-x-5' : 'translate-x-0'
                                            } h-5 w-5`}
                                        ></span>
                                      </button>
                                      {/* =============radio btn============== */}
              ...
              {editor_full_screen
                ...
                <>
                  {delta
                    ...
                    <>
                      <div className=" relative overflow-auto grow shrink">
                        <div className=" min-h-full flex flex-col relative bg-white [&amp;>div]:border-none">
                          <div className="dark:bg-gray-700 relative bg-white border border-gray-300 flex flex-col grow">
                            {editorData &&
                              <>
                                {hide_editor_while_sharing == false
                                  ?
                                  <div className="App show_popup_above_this_div p-10 dark:bg-gray-700">
                                    <Editor data={editorData} setData={seteditorData} />
                                  </div>
                                  :
                                  null
